...
class DTAppTableQueue extends \MVC\DB\DataType\DB\TableDataType
{
     ...
     * @var string
     */
    protected $key {set => substr($value, 0, 255);}

    /**
     * @required true
     * @var string|null
     */
    protected $key2 {set => substr($value, 0, 255);}

    /**
     * @required true
     * @var string
     */
    protected $value {set => substr($value, 0, 16000);}

    /**
     * @required true
     * @var string
     */
    protected $valueMd5 {set => substr($value, 0, 32);}
